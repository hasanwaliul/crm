...
@section('content')
  ...
  <div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{ route('expense.update',$data->expens_id) }}" enctype="multipart/form-data" id="customerForm">
          @csrf
          @method('put')
          <div class="card">
            <div class="card-header custom-card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fab fa-gg-circle"></i> Edit Expense</h3>
                    </div>
            ...
            <div class="card-body card_form">
                    ...
                    <div class="col-sm-5">
                        <select class="form-control" name="exp_cat_id" id="search_select2" required>
                          ...
                          @foreach ($category as $catg)
                            <option value="{{ $catg->exp_cat_id }}" {{ $catg->exp_cat_id == $data->exp_cat_id ? 'selected' : '' }}>{{ $catg->exp_cat_name }}</option>
                          @endforeach
                        </select>
                        @error('in_cat_id')
                ...
                <div class="form-group custom_form_group row mb-3">
                    ...
                    <div class="col-sm-5">
                        <input type="text" placeholder="Amount..." class="form-control" name="expens_amount" value="{{ $data->expens_amount }}" required data-parsley-pattern="[0-9]+$" data-parsley-length="[0,15]" data-parsley-trigger="keyup">
                        @error('expens_amount')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-group custom_form_group row mb-3">
                    ...
                    <div class="col-sm-5">
                        <textarea name="expens_details" rows="3" cols="80" class="form-control" placeholder="Remarks Here..." required>{{ $data->expens_details }}</textarea>
                ...
                <div class="form-group row mb-3 ">
                    ...
                    <div class="col-sm-5">
                        <div class="input-group">
                            <input type="text" class="form-control form_control" id="birththday" name="expens_date" value=" {{ $data->expens_date }}">
