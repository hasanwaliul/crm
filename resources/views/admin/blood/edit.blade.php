...
@section('content')
  ...
  <div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{ route('blood.update',$data->blood_group_id) }}" enctype="multipart/form-data" id="customerForm">
          @csrf
          @method('put')
          <div class="card">
            <div class="card-header custom-card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fab fa-gg-circle"></i> Edit Blood Group</h3>
                    </div>
            ...
            <div class="card-body card_form">
                <div class="row">
                  <div class="form-group custom_form_group col-md-6 m-auto">
                      ...
                      <div class="">
                          <input type="text" placeholder="Blood Group Name" class="form-control" name="name" value="{{ $data->name }}" required>
                          @error('name')
