    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header custom-card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fab fa-gg-circle mr-2"></i>Pending Expense</h3>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table id="alltableinfo" class="table table-bordered custom_table mb-0">
                                ...
                                {{-- main work --}}
                                <tbody>
                                   @forelse ($pendingExpense as $data)
                                   <tr>
                                     ...
                                     <td style="width:17%">
                                       <a class="btn btn-success btn-sm" id="approve" href="{{ route('approved-expense',$data->expens_id) }}"><i class="fas fa-thumbs-up"></i></a>
                                       <a class="btn btn-danger btn-sm" href="{{ route('delete-expense',$data->expens_id) }}" id="delete"><i class="fas fa-trash-alt"></i></a>
